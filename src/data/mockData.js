...
export const portfolioData = [
  { id: 1, name: "uh!ive", sector: "Voice AI", stage: "Series A", runway: 5, runwayTrend: "down", cashPosition: 1.8, burn: 0.35, ownership: null, invested: null, usExpansion: "none", canRaise: false },
  { id: 2, name: "Ada Health", sector: "Digital Health", stage: "Series B", runway: 6, runwayTrend: "down", cashPosition: 12, burn: 2, ownership: 3.2, invested: 8.5, usExpansion: "active", canRaise: false },
  { id: 3, name: "ZML", sector: "AI Infrastructure", stage: "Series A", runway: 18, runwayTrend: "stable", cashPosition: 8, burn: 0.45, ownership: 5.1, invested: 3.2, usExpansion: "planned", canRaise: true },
  { id: 4, name: "Resilience", sector: "Digital Health", stage: "Series B", runway: 14, runwayTrend: "up", cashPosition: 15, burn: 1.1, ownership: 4.8, invested: 6.5, usExpansion: "active", canRaise: true },
  { id: 5, name: "HyPr Space", sector: "New Space", stage: "Series A", runway: 24, runwayTrend: "stable", cashPosition: 20, burn: 0.85, ownership: 12.5, invested: 5, usExpansion: "none", canRaise: true },
  { id: 6, name: "Veesion", sector: "AI/Retail Tech", stage: "Series B", runway: 16, runwayTrend: "up", cashPosition: 18, burn: 1.1, ownership: 6.2, invested: 4.5, usExpansion: "active", canRaise: true },
  { id: 7, name: "Worldia", sector: "Travel Tech", stage: "Series B", runway: 10, runwayTrend: "stable", cashPosition: 8, burn: 0.8, ownership: 7.8, invested: 5.5, usExpansion: "planned", canRaise: true },
  { id: 8, name: "Jiko", sector: "Fintech", stage: "Series C", runway: 20, runwayTrend: "up", cashPosition: 25, burn: 1.25, ownership: 4.1, invested: 8, usExpansion: "active", canRaise: true },
  { id: 9, name: "iObeya", sector: "Enterprise SaaS", stage: "Series A", runway: 15, runwayTrend: "stable", cashPosition: 6, burn: 0.4, ownership: 9.5, invested: 3.5, usExpansion: "planned", canRaise: true },
  { id: 10, name: "Le Collectionist", sector: "Luxury Travel", stage: "Venture", runway: 8, runwayTrend: "down", cashPosition: 4, burn: 0.5, ownership: 11.2, invested: 4, usExpansion: "active", canRaise: false },
  { id: 11, name: "WeMaintain", sector: "Proptech", stage: "Series B", runway: 12, runwayTrend: "stable", cashPosition: 10, burn: 0.85, ownership: 8.5, invested: 6, usExpansion: "planned", canRaise: true }
];
