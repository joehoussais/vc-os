...
export const portfolioData = [
  { id: 1, name: "Allo Media / UhLive", sector: "Voice AI", stage: "Series A", runway: 5, runwayTrend: "down", cashPosition: 1.8, burn: 0.35, ownership: null, invested: null, usExpansion: "none", canRaise: false, boardMembers: [{ name: 'Luc-Emmanuel', role: 'board' }] },
  { id: 2, name: "Ada Health", sector: "Digital Health", stage: "Series B", runway: 6, runwayTrend: "down", cashPosition: 12, burn: 2, ownership: 3.2, invested: 8.5, usExpansion: "active", canRaise: false, boardMembers: [] },
  ...
  { id: 5, name: "HyPr Space", sector: "New Space", stage: "Series A", runway: 24, runwayTrend: "stable", cashPosition: 20, burn: 0.85, ownership: 12.5, invested: 5, usExpansion: "none", canRaise: true, boardMembers: [{ name: 'Luc-Emmanuel', role: 'board' }] },
  { id: 6, name: "Veesion", sector: "AI/Retail Tech", stage: "Series B", runway: 16, runwayTrend: "up", cashPosition: 18, burn: 1.1, ownership: 6.2, invested: 4.5, usExpansion: "active", canRaise: true, boardMembers: [{ name: 'Joseph', role: 'board' }, { name: 'Luc-Emmanuel', role: 'board' }] },
  ...
  { id: 8, name: "Jiko", sector: "Fintech", stage: "Series C", runway: 20, runwayTrend: "up", cashPosition: 25, burn: 1.25, ownership: 4.1, invested: 8, usExpansion: "active", canRaise: true, boardMembers: [] },
  { id: 9, name: "iObeya", sector: "Enterprise SaaS", stage: "Series A", runway: 15, runwayTrend: "stable", cashPosition: 6, burn: 0.4, ownership: 9.5, invested: 3.5, usExpansion: "planned", canRaise: true, boardMembers: [{ name: 'Antoine', role: 'board' }] },
  ...
  { id: 11, name: "WeMaintain", sector: "Proptech", stage: "Series B", runway: 12, runwayTrend: "stable", cashPosition: 10, burn: 0.85, ownership: 8.5, invested: 6, usExpansion: "planned", canRaise: true, boardMembers: [{ name: 'Antoine', role: 'board' }] },
  { id: 12, name: "Okeiro", sector: "Digital Health", stage: "Series A", runway: 22, runwayTrend: "stable", cashPosition: 7, burn: 0.32, ownership: 15.0, invested: 3.5, usExpansion: "none", canRaise: true, boardMembers: [{ name: 'Joseph', role: 'board' }, { name: 'Luc-Emmanuel', role: 'board' }] },
  { id: 13, name: "Otera", sector: "AI/Automation", stage: "Series A", runway: 14, runwayTrend: "up", cashPosition: 5, burn: 0.35, ownership: 8.0, invested: 3.0, usExpansion: "planned", canRaise: true, boardMembers: [{ name: 'Olivier', role: 'board' }] },
  { id: 14, name: "Robovision", sector: "AI/Computer Vision", stage: "Series A", runway: 12, runwayTrend: "down", cashPosition: 6, burn: 0.5, ownership: 10.0, invested: 5.0, usExpansion: "none", canRaise: true, boardMembers: [{ name: 'Olivier', role: 'board' }] },
  { id: 15, name: "TEC", sector: "New Space", stage: "Series B", runway: 18, runwayTrend: "stable", cashPosition: 14, burn: 0.78, ownership: 6.0, invested: 4.0, usExpansion: "active", canRaise: true, boardMembers: [{ name: 'Alfred', role: 'board' }] },
  { id: 16, name: "Speach", sector: "Enterprise SaaS", stage: "Series A", runway: 20, runwayTrend: "up", cashPosition: 5, burn: 0.25, ownership: 12.0, invested: 2.5, usExpansion: "none", canRaise: true, boardMembers: [{ name: 'Joseph', role: 'board' }, { name: 'Alfred', role: 'board' }] }
];
