...
export const FUNDS = [
  ...
  { id: 'fund3', name: 'Fund III (RRW3)', statusSlug: 'rrw_3_status', amountSlug: 'amount_rrw', currency: 'EUR' },
  ...
  const processLPs = useCallback((rawLPs) => {
    return rawLPs.map(lp => {
      ...
      return {
        ...
        commitAmount,
        commitPriority,
        // Fund III — use Attio amount_rrw, fall back to >Commit amount
        fund3Status,
        fund3Amount: fund3Amount || commitAmount || null,
        fund3AmountIsEstimate: !fund3Amount && !!commitAmount,
        fund3Priority,
        fund3Interest,
        // Fund II (derived)
